  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': { boxShadow: '0 0 5px rgba(233, 29, 36, 0.5)' },
          '50%': { boxShadow: '0 0 20px rgba(233, 29, 36, 0.8)' },
        },
      },
      boxShadow: {
        'tech': '0 0 15px rgba(233, 29, 36, 0.3)',
        'neon': '0 0 10px rgba(233, 29, 36, 0.6), 0 0 20px rgba(233, 29, 36, 0.3), 0 0 30px rgba(233, 29, 36, 0.1)',
      },
    },
  },
  plugins: [],
